...
class Website
{
    ...
    {
        $result = $this->client->Send('/pt-br/api/companycandidate/' . $pk . '/websites/', $data);
        if ($result) {
            return $result;
        }
    ...
    {
        $result = $this->client->Update('/pt-br/api/companycandidate/' . $pk . '/websites/' . $data['id'] . '/', $data);
    ...
    {
        $result = $this->client->Delete('/pt-br/api/companycandidate/' . $pk . '/websites/' . $data['id'] . '/');
