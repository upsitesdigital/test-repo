...
class WorkExperience
{
    ...
    {
        $result = $this->client->Send('/pt-br/api/companycandidate/' . $pk . '/work/', $data);
        if ($result) {
            return $result;
        }
    ...
    {
        $result = $this->client->Update('/pt-br/api/companycandidate/' . $pk . '/work/' . $data['id'] . '/', $data);
    ...
    {
        $result = $this->client->Get('/pt-br/api/companycandidate/' . $pk . '/work/' . $data['id'] . '/');
